...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<BruskovaVGlobalOptimizationMPI, InType, OutType, TestType>(kTestParam, "bruskova_v_global_optimization_mpi"),
    ppc::util::AddFuncTask<BruskovaVGlobalOptimizationSEQ, InType, OutType, TestType>(kTestParam, "bruskova_v_global_optimization_seq"));
